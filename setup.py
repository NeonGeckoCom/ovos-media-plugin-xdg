...
def get_version():
    ...
    version = None
    version_file = os.path.join(BASEDIR, 'ovos_media_plugin_xdg', 'version.py')
...
setup(
    name='ovos-media-plugin-xdg',
    version=get_version(),
    description='xdg OCP plugin for ovos',
    url='https://github.com/OpenVoiceOS/ovos-media-plugin-xdg',
    author='JarbasAi',
    author_email='jarbasai@mailfence.com',
    license='Apache-2.0',
    packages=['ovos_media_plugin_xdg'],
